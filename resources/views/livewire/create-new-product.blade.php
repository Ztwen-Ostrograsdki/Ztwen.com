<x-z-modal-generator :icon="'fa bi-tag fa-2x'" :modalName="'createProductModal'" :modalHeaderTitle="'Creation d\'un article'" :modalBodyTitle="'Création d\'un article'">
