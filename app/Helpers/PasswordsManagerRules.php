...
class PasswordManagerRule
{
     ...
     * Class constructor.
     */
    public function __construct(bool $requireUppercase = false, bool $requireNumeric = false, bool $requireSpecialCharacter = false, $length = 8)
    {
